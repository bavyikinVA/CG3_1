...
namespace CG3
{
    public partial class Form1 : Form
    {
        ...
        {
            double turn = Convert.ToDouble(textBox3.Text);
            double TransferX = Convert.ToDouble(textBox4.Text);
            double TransferY = Convert.ToDouble(textBox5.Text);
            double StretchingX = Convert.ToDouble(textBox1.Text);
            double StretchingY = Convert.ToDouble(textBox2.Text);
